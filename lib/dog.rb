...
# Additionally, Dog #initialize should accept a second optional argument for the dog's breed 
# stored in an instance variable @breed. When no breed is provided, it should default to "Mutt".
